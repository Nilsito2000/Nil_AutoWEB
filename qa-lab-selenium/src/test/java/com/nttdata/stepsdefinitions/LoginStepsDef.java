...
public class LoginStepsDef {
    ...
    @Entonces("agrego un item al carrito  de compras")
    public void agrego_un_item_al_carrito_de_compras() {
        InventorySteps inventorySteps = new InventorySteps(driver);
        inventorySteps.unproductoclic();
        screenShot();
    }
    @Entonces("reviso que el carrito de compras tenga un item agregado")
    public void reviso_que_el_carrito_de_compras_tenga_un_item_agregado() {
        InventorySteps inventorySteps = new InventorySteps(driver);
        inventorySteps.añadircarritoclic();
        screenShot();
    }
  ...
  @Entonces("valido que el item agregado se llame {string}")
    public void valido_que_el_item_agregado_se_llame(String titulonom) {
         InventorySteps inventorySteps = new InventorySteps(driver);
        try {
