...
public class InventorySteps {
    ...
    public void unproductoclic() {
        this.driver.findElement(InventoryPage.Producto).click();
    }
    ...
    public String getcarritoTitulo(){
        return this.driver.findElement(InventoryPage.añadircarritotext).getText();
    }
